        <aside>
            ...
            <section className="poster"><img src="" alt="" /></section>
            ...
            <section className="info6"></section>
            <section className="info7"></section>
            <section className="info8"></section>
            <section className="info9"></section>
            <section className="info10"></section>
            <section className="info11"></section>
            <section className="info12"></section>
            <section className="info13"></section>
            <section className="info14"></section>
            <section className="info15"></section>
        </aside>
